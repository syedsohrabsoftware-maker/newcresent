...
import { 
  Target, Eye, Award, Users, Zap, ShieldCheck, 
  Star, GraduationCap, ArrowRight, CheckCircle2
} from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-slate-500 text-xl leading-relaxed max-w-xl font-medium">
                New Crescent Public School (NCPS) Mewat ka wo leading digital school hai jahan academic rigor aur character development par focus kiya jata hai.
              </p>
            ...
            >
              <div className="aspect-[4/5] rounded-[60px] bg-slate-200 overflow-hidden shadow-2xl relative border-8 border-white">
                 <Image 
                   src="/building1.jpg" 
                   alt="New Crescent Public School Building - Best CBSE School in Pinangwan Mewat"
                   fill
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
            {stats.map((stat, idx) => (
              <div key={idx} className="group cursor-default">
                <stat.icon className={`${stat.color} mb-4 mx-auto md:mx-0 group-hover:scale-110 transition-transform`} size={32} />
        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-16 grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Hum har student ko digital tools, mazboot character aur curiosity ke saath 21st-century ke liye taiyaar karte hain. Hum traditional values aur modern technology ke beech ka bridge hain.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Mewat aur Haryana mein educational excellence ka benchmark banna, aur aise global citizens nurture karna jo confidence aur integrity ke saath duniya badal sakein.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-[1440px] mx-auto px-8 md:px-16 flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-500 text-lg font-medium">Hum sirf syllabus nahi padhate, hum aisi personality banate hain jo communities ko lead karein.</p>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-16 grid md:grid-cols-3 gap-10">
          {[
            { title: "Smart Learning", desc: "Interactive digital classrooms aur high-tech labs jo real experience dete hain.", icon: Zap, bg: "bg-orange-50", text: "text-orange-600" },
            { title: "Safe Campus", desc: "100% CCTV coverage aur strictly vetted staff aapke bacho ki suraksha ke liye.", icon: ShieldCheck, bg: "bg-blue-50", text: "text-blue-600" },
            { title: "Excellence", desc: "Academic results jo consistently district mein top rank par aate hain.", icon: Star, bg: "bg-emerald-50", text: "text-emerald-600" },
          ].map((val, i) => (
      ...
      <section className="pb-32 px-8">
        <div className="max-w-[1200px] mx-auto rounded-[60px] bg-slate-900 p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight uppercase">Bacho ke Future mein Invest karein</h2>
